...
MIDDLEWARE = [
    ...
    'ecommerce_app.middleware.BlockUserMiddleware',
]
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Separate directory for collected files
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Source static files
]
